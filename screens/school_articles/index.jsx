...
export default function SchoolArticles() {
  ...
  return (
    ...
    <div className={Styles.article}>
      <div className={Styles.header}>
        <h2 className="mb-4">School Articles</h2>
      </div>

      <div className={`${Styles.entriesLimit} mb-3`}>
        <span>Show</span>
        <select className={Styles.pageSelect} onChange={onOptionChangeHandler}>
        ...
        <div className={Styles.filter}>
          <Form inline>
            <Row className="g-0">
              ...
              <Col xs="auto" sm="6">
                <Button type="submit" moduleClass="btn-type1" className="ms-3">
                  Search
                </Button>
              </Col>
            </Row>
